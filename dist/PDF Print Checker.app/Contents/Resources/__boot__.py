...
_recipes_pil_prescript(['JpegImagePlugin', 'GifImagePlugin', 'IcoImagePlugin', 'WebPImagePlugin', 'IcnsImagePlugin', 'XpmImagePlugin', 'DdsImagePlugin', 'BufrStubImagePlugin', 'QoiImagePlugin', 'GbrImagePlugin', 'WmfImagePlugin', 'BlpImagePlugin', 'AvifImagePlugin', 'ImImagePlugin', 'SpiderImagePlugin', 'FtexImagePlugin', 'PsdImagePlugin', 'TgaImagePlugin', 'XbmImagePlugin', 'ImtImagePlugin', 'Jpeg2KImagePlugin', 'FitsImagePlugin', 'TiffImagePlugin', 'MpoImagePlugin', 'Hdf5StubImagePlugin', 'GribStubImagePlugin', 'SunImagePlugin', 'PcxImagePlugin', 'XVThumbImagePlugin', 'CurImagePlugin', 'PcdImagePlugin', 'IptcImagePlugin', 'PalmImagePlugin', 'FpxImagePlugin', 'FliImagePlugin', 'EpsImagePlugin', 'PixarImagePlugin', 'SgiImagePlugin', 'MicImagePlugin', 'MpegImagePlugin', 'BmpImagePlugin', 'DcxImagePlugin', 'PngImagePlugin', 'McIdasImagePlugin', 'PdfImagePlugin', 'MspImagePlugin', 'PpmImagePlugin'])
...
DEFAULT_SCRIPT='pdf_print_checker.py'
SCRIPT_MAP={}
_run()
