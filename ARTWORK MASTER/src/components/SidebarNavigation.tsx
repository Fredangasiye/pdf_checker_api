  ...
  const mainCards = [
    {
      ...
      icon: (isSelected: boolean) => (
        <svg className={`w-4 h-4 ${isSelected ? 'text-white' : 'text-purple-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        {
          ...
          label: 'File Upload',
          icon: (isSelected: boolean) => (
            <svg className={`w-3 h-3 ${isSelected ? 'text-white' : 'text-purple-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        {
          ...
          description: 'Artwork Guidelines, Company Policies, Training Manuals'
        }
      ]
    }
  ]
            ...
            {mainCards.filter(card => card.id === 'artwork').map((card) => (
              <div key={card.id} className="space-y-2">
                ...
                <button
                  ...
                  className={`w-full flex items-center px-2 py-3 text-xs font-medium rounded transition-all duration-300 hover:scale-105 hover:shadow-md ${expandedCard === card.id
                    ...
                    {card.items.map((item) => (
                      <div key={item.id} className="space-y-2">
                        <button
                          ...
                          className={`w-full flex items-center px-2 py-3 text-xs font-medium rounded transition-all duration-300 hover:scale-105 hover:shadow-md ${activeTool === item.id
        ...
        <div className="p-1 space-y-2">
          {mainCards.map((card) => (
            <div key={card.id} className="space-y-2">
              ...
              <button
                onClick={() => handleCardClick(card.id)}
                className={`w-full flex items-center justify-center px-2 py-3 text-xs font-medium rounded transition-all duration-300 hover:scale-105 hover:shadow-md ${expandedCard === card.id
                    ? `bg-gradient-to-r ${card.color} text-white shadow-md`
                    : 'text-gray-800 hover:text-gray-900 hover:bg-gray-50 border border-gray-200'
                  }`}
                title={card.title}
                ...
                <div className="space-y-2">
                  {card.items.map((item) => (
                    <button
                      key={item.id}
                      onClick={() => onToolChange(item.id)}
                      className={`w-full flex items-center justify-center px-2 py-3 text-xs font-medium rounded transition-all duration-300 hover:scale-105 hover:shadow-md ${activeTool === item.id
      ...
      {!isCollapsed && (
        <div className="p-4 pt-2 border-t border-gray-200">
          ...
          <div className="flex space-x-3">
            <a href="#" className="group p-2 text-gray-500 hover:text-purple-600 hover:bg-purple-50 hover:scale-110 hover:rotate-3 transition-all duration-300 ease-in-out rounded-lg border border-transparent hover:border-purple-200 hover:shadow-lg" title="Website">
              <svg className="w-5 h-5 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
              </svg>
            </a>
            <a href="#" className="group p-2 text-gray-500 hover:text-purple-700 hover:bg-purple-50 hover:scale-110 hover:rotate-3 transition-all duration-300 ease-in-out rounded-lg border border-transparent hover:border-purple-200 hover:shadow-lg" title="LinkedIn">
              <svg className="w-5 h-5 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <a href="#" className="group p-2 text-gray-500 hover:text-purple-500 hover:bg-purple-50 hover:scale-110 hover:rotate-3 transition-all duration-300 ease-in-out rounded-lg border border-transparent hover:border-purple-200 hover:shadow-lg" title="Twitter">
              <svg className="w-5 h-5 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
